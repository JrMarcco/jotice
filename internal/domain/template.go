...
// ChannelTpl domain model of channel template.
...
// ChannelTplVersion domain model of channel template version.
...
// ChannelTplProvider domain model of channel template provider.
